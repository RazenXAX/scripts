...
ro.vendor.build.fingerprint=Xiaomi/warm_global/warm:14/UKQ1.240624.001/OS3.0.3.0.WGVINXM:user/release-keys
ro.odm.product.cpu.abilist=arm64-v8a
ro.odm.product.cpu.abilist32=
ro.odm.product.cpu.abilist64=arm64-v8a
ro.odm.build.date=Thu Jan 29 16:29:19 CST 2026
ro.odm.build.date.utc=1769675359
ro.odm.build.fingerprint=Xiaomi/warm_global/warm:14/UKQ1.240624.001/OS3.0.3.0.WGVINXM:user/release-keys
ro.odm.build.id=UKQ1.240624.001
ro.odm.build.tags=release-keys
ro.odm.build.type=user
ro.odm.build.version.incremental=OS3.0.3.0.WGVINXM
